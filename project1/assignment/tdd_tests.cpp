...
protected:
    virtual void SetUp() {
        int values[] = { 10, 85, 5, 15, 70, 20, 60, 30, 50, 65, 80, 90, 40, 5, 55 };
...
TEST_F(NonEmptyQueue, RemoveAllForward)
{
    ...
    int values[] = { 5, 5, 10, 15, 20, 30, 40, 50, 55, 60, 65, 70, 80, 85, 90 };
    for(int i = 0; i < 14; ++i)
    {
...
TEST_F(NonEmptyQueue, RemoveAllBackward)
{
    ...
    int values[] = { 90, 85, 60, 55, 80, 70, 30, 20, 65, 10, 50, 40, 15, 5, 5 };
    for(int i = 0; i < 14; ++i)
    {
        EXPECT_TRUE(queue.Remove(values[i]));
...
{
    int values[] = { 5, 10, 30, 40, 15, 60, 65, 20, 50, 80, 85, 55, 70, 90 };
    for(int i = 0; i < 14; ++i)
    {
